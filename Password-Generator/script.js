class password {
  constructor() {
	...
	funnyPassword(){
		let arr= ["password","incorrect","12345678","iforgot","secret","MyPreciousssPasssword","MyName","XXX_Hacker","nothing","user","maiNahiBatungi","Sorry","1$perhour","admin","passwordIs1234"]
